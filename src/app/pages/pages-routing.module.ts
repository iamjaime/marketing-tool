...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'likes', loadChildren: './component/likes/likes.module#LikesModule' },
            ...
            { path: 'comments', loadChildren: './component/comments/comments.module#CommentsModule' },
            { path: 'posts', loadChildren: './component/posts/posts.module#PostsModule' },
            { path: 'shared', loadChildren: './component/shared/shared.module#SharedModule' },
            { path: 'face', loadChildren: './component/face/face.module#FaceModule' },
